...
gulp.task('watch', function (done) {
    gulp.watch('src/**/*', ['lessmin', 'build-js', 'include'])
        .on('end', done);
});
...
//发布
gulp.task('default', ['connect', 'include', 'md5:css', 'md5:js', 'open']);

//开发
gulp.task('dev', ['watch', 'connect', 'copy:images', 'include', 'lessmin', 'build-js', 'open']); 