...
function videoSample(aflaxRef, cueCallback, loadCallback)
{
	this.aflax = aflaxRef;
	this.flash = this.aflax.getFlash();
	this.play(cueCallback, loadCallback);
}
...
videoSample.prototype.play = function(cueCallback, loadCallback)
{
	this.video = new AFLAX.VideoClip(this.aflax, null, 
		"../../examples/video/autocross.flv", cueCallback, loadCallback);
}
