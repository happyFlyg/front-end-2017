...
function checkWinSize(){		//检测窗口大小
	...
	document.getElementById('p3_bg').style.width=winWidth+"px";
	document.getElementById('p3_bg').style.height=winHeight+"px";
	...
	if(winWidth>winHeight){	//横屏
		...
		if(initState==0){		//初始化播放器
			document.getElementById('videoContainer').innerHTML='<video autoplay="autoplay" loop="loop" id="myVideobox"><source src="images/bgsound.mp3"></video>';
